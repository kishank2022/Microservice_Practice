...
public class GeneratePCCVProposalResultResponseDto {
	...
	public GeneratePCCVProposalResultResponseDto() {
		super();
		// TODO Auto-generated constructor stub
	}
	public GeneratePCCVProposalResultResponseDto(String pOL_SYS_ID, String pROPOSAL_NO, String vehicleIDV,
			String eRROR_DESC, String eRROR_CODE, List<CoverDtlListDto> coverDtlList) {
		super();
	...
	public String toString() {
		return "GeneratePCCVProposalResultResponseDto [pOL_SYS_ID=" + pOL_SYS_ID + ", pROPOSAL_NO=" + pROPOSAL_NO
