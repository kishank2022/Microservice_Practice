...
public class GenerateCarProposalPolicyEntryEntityRequestDto {
	...
	public GenerateCarProposalPolicyEntryEntityRequestDto(String referenceNo, String prodCode, String policyFromDt,
	...
	public String toString() {
		return "GenerateCarProposalPolicyEntryEntityRequestDto [ReferenceNo=" + ReferenceNo + ", ProdCode=" + ProdCode
				+ ", PolicyFromDt=" + PolicyFromDt + ", PolicyToDt=" + PolicyToDt + ", PolicyIssueDt=" + PolicyIssueDt
				+ ", InsuredPrefix=" + InsuredPrefix + ", InsuredName=" + InsuredName + ", Gender=" + Gender
				+ ", Address1=" + Address1 + ", Address2=" + Address2 + ", Address3=" + Address3 + ", State=" + State
				+ ", City=" + City + ", PinCode=" + PinCode + ", PanNo=" + PanNo + ", GSTNo=" + GSTNo + ", TelephoneNo="
				+ TelephoneNo + ", ProposalType=" + ProposalType + ", PolicyType=" + PolicyType + ", DateOfBirth="
				...
				+ ", IDV_of_Vehicle=" + IDV_of_Vehicle + ", Colour=" + Colour + ", VoluntaryExcess=" + VoluntaryExcess
				...
				+ NFPP_OthThanEmp + ", LimitOwnPremiseYN=" + LimitOwnPremiseYN + ", Bangladesh=" + Bangladesh
