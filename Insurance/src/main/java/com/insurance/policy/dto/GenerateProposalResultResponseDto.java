...
public class GenerateProposalResultResponseDto {
	...
	public GenerateProposalResultResponseDto() {
		super();
	...
	public String toString() {
		return "GenerateProposalResultResponseDto [pOL_SYS_ID=" + pOL_SYS_ID + ", pROPOSAL_NO=" + pROPOSAL_NO
				+ ", vehicleIDV=" + vehicleIDV + ", eRROR_DESC=" + eRROR_DESC + ", eRROR_CODE=" + eRROR_CODE
				+ ", coverDtlList=" + coverDtlList + "]";
	}

	public GenerateProposalResultResponseDto(String pOL_SYS_ID, String pROPOSAL_NO, String vehicleIDV,
